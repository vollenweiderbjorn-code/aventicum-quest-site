...
(function () {
  ...
  const T = {
    ...
    fr: {
      ...
      'cgv-a3-ul':     '<li>Adulte (dès 18 ans) : <strong>12 CHF</strong></li><li>Enfant (5 à 17 ans) : <strong>8 CHF</strong></li><li>Moins de 5 ans : <strong>gratuit</strong></li>',
      'cgv-a3-p2':     'Un seul code est généré par commande et donne accès à la partie pour toute l\'équipe, quel que soit le nombre de participants déclaré lors de l\'achat.',
      ...
      'conf-h2d':      'Mesure d\'audience',
      'conf-p2e':      'Pour comprendre la fréquentation du site, nous utilisons <strong>Plausible Analytics</strong>, un outil de mesure d\'audience respectueux de la vie privée, hébergé dans l\'Union européenne. Plausible ne dépose <strong>aucun cookie</strong>, ne collecte <strong>aucune donnée personnelle</strong> et ne permet pas de vous identifier ni de vous suivre d\'un site à l\'autre. Seules des statistiques agrégées et anonymes sont mesurées (pages vues, provenance, type d\'appareil). Aucune donnée n\'est vendue ni partagée à des fins publicitaires. En savoir plus : <a href="https://plausible.io/data-policy" target="_blank" rel="noopener">plausible.io/data-policy</a>.',
    ...
    en: {
      ...
      'av-s1-p1':      'The heart of the town is still organized around the remains of Aventicum. The arena, one of the best-preserved Roman amphitheatres in Switzerland, still hosts open-air events today, such as the Avenches Tattoo, the Avenches Open Air festival and the Carnival. A short walk away, the Cigognier sanctuary and its tower stand out with their striking silhouette in the open countryside. The Roman Museum of Avenches, housed in the amphitheatre tower, traces two thousand years of history through objects found on site.',
      ...
      'cgv-a3-ul':     '<li>Adult (18 years and over): <strong>CHF 12</strong></li><li>Child (5 to 17 years): <strong>CHF 8</strong></li><li>Under 5 years: <strong>free</strong></li>',
      'cgv-a3-p2':     'A single code is generated per order and gives access to the game for the whole team, regardless of the number of participants declared at purchase.',
      ...
      'conf-h2d':      'Audience measurement',
      'conf-p2e':      'To understand site traffic, we use <strong>Plausible Analytics</strong>, a privacy-friendly analytics tool hosted in the European Union. Plausible sets <strong>no cookies</strong>, collects <strong>no personal data</strong> and cannot identify you or track you across sites. Only aggregated, anonymous statistics are measured (page views, referrer, device type). No data is sold or shared for advertising purposes. Learn more: <a href="https://plausible.io/data-policy" target="_blank" rel="noopener">plausible.io/data-policy</a>.',
    ...
    de: {
      ...
      'av-s1-p1':      'Das Herz der Stadt ist noch immer um die Überreste von Aventicum organisiert. Die Arena, eines der am besten erhaltenen römischen Amphitheater der Schweiz, ist bis heute Schauplatz von Freiluftveranstaltungen wie dem Avenches Tattoo, dem Avenches Open Air und dem Fasnachtsumzug. Wenige Minuten entfernt beeindrucken das Cigognier-Heiligtum und sein Turm mit ihrer markanten Silhouette inmitten der Landschaft. Das Römermuseum von Avenches, untergebracht im Amphitheaterturm, erzählt zweitausend Jahre Geschichte anhand von vor Ort gefundenen Objekten.',
      ...
      'cgv-a3-ul':     '<li>Erwachsener (ab 18 Jahren): <strong>12 CHF</strong></li><li>Kind (5 bis 17 Jahre): <strong>8 CHF</strong></li><li>Unter 5 Jahren: <strong>gratis</strong></li>',
      'cgv-a3-p2':     'Pro Bestellung wird ein einziger Code erzeugt, der unabhängig von der beim Kauf angegebenen Teilnehmerzahl Zugang für das ganze Team gewährt.',
      ...
      'conf-h2d':      'Reichweitenmessung',
      'conf-p2e':      'Um die Nutzung der Website zu verstehen, verwenden wir <strong>Plausible Analytics</strong>, ein datenschutzfreundliches Analysetool, das in der Europäischen Union gehostet wird. Plausible setzt <strong>keine Cookies</strong>, erhebt <strong>keine personenbezogenen Daten</strong> und kann Sie weder identifizieren noch website-übergreifend verfolgen. Es werden nur aggregierte, anonyme Statistiken erfasst (Seitenaufrufe, Herkunft, Gerätetyp). Es werden keine Daten verkauft oder zu Werbezwecken weitergegeben. Mehr erfahren: <a href="https://plausible.io/data-policy" target="_blank" rel="noopener">plausible.io/data-policy</a>.',
